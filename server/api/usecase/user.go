...
func (u *userUsecase) CreateUserHandler(ctx *gin.Context, req *dto.UserValidator) (*entity.UserSchema, error) {
...
func (u *userUsecase) LoginUserHandler(ctx *gin.Context, req dto.UserLoginValidator) (*entity.UserSchema, error) {
